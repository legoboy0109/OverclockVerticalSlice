...
How the remap works: hue is replaced outright, while saturation and value are
*scaled* by the target anchor's ratio to the rush anchor rather than being set
...
def main() -> None:
    ...
    img, n = recolor(args.src, args.faction, args.sat_min)
    if not n:
