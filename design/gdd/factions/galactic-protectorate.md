...
| POQ-5 | ★ **Does the Protectorate overlap the Machinist's Union?** Both are vehicle-forward and both are few-and-strong. The intended separation is that the Protectorate is **bimodal** (disposable junk *plus* elite specialists) while the Union is **uniformly excellent**. That distinction must be protected when the Union is authored, or two of six factions blur | user + game-designer |
