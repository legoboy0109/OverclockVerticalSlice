...
| DAOQ-5 | ★ **Does the Alliance need a dedicated pilot at all?** TP-5c gives Light and Medium `can_pilot`. That is the generalist answer and it costs the faction nothing — which may make Solar's dedicated Pilot specialist look strictly worse. Solar's version must therefore be *better at something* (cheaper, or grants a vehicle bonus), not merely necessary | systems-designer |
