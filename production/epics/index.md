...
- **Core** (5 epics): In progress — the three VS-critical epics are ✅ **Complete**:
  Unit System (10/10), Movement (3/3), Combat Resolution (8/8). Base & Production and
  Research/Tech have Accepted ADRs (0017/0018) but no story breakdowns yet
  (`/create-stories base-production` / `research-tech`). VS-critical order was
  **Unit System → Movement → Combat Resolution** (Base & Production and Research/Tech
  follow after the vertical slice). Movement's QQ-05 perf-spike gate (Sprint 2 S2-03)
