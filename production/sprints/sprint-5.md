...
| S5-08 | Colourblind ownership decision — non-hue markers or documented accept | art-director / creative-director | 1 | — | **⚠ RE-MEASURED 2026-08-20 — this row's original framing was backwards.** Δ34/255 was the *peak* on the brightest trim pixels, not what a player perceives, and the units/structures verdict was inverted. Units are the STRONG case (26–82% accent coverage, ΔE 60–76 deuteranopia); **structures are the weak case** (5–22%), with the Defensive Structure at ΔE 2.3 whole-silhouette **under normal colour vision** — an ownership defect affecting everyone. The locked hue pair passes all three named dichromacies unaided; full desaturation fails. Also found: §5.2's non-hue backup was never built (all 26 sprite pairs are pixel-identical). **Decision 2026-08-20: user chose D+A** — accept + correct the docs (done), fix structure coverage (mechanism re-specified, see brief). Evidence: `production/qa/evidence/s5-08-colourblind-ownership-brief.md` |
